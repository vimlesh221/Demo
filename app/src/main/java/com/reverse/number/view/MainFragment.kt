package com.reverse.number.view
...
import com.reverse.number.databinding.FragmentMainBinding
...
class MainFragment: Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.fragmentEditView.addTextChangedListener { it: Editable? ->
           text=it.toString()
        }
        setupClickListeners()
    ...
    private fun setupClickListeners() {
        binding.fragmentButton.setOnClickListener { viewModel.getReverseNumber(text.toInt()) }
    }
